...
export const AUTOMATIONS: Automation[] = [
  // ===== 1. AI Email Triage =====
  {
    ...
    diagramImage: '/automations/email-triage.webp',
  ...
  // ===== 2. Invoice & Document OCR =====
  {
    ...
    diagramImage: '/automations/document-ocr.webp',
  ...
  // ===== 3. RAG Knowledge Base Chatbot =====
  {
    ...
    diagramImage: '/automations/rag-chatbot.webp',
  ...
  // ===== 4. Lead Scoring & CRM =====
  {
    ...
    diagramImage: '/automations/lead-scoring.webp',
  ...
  // ===== 5. AI Social Media Content Engine =====
  {
    ...
    diagramImage: '/automations/social-media.webp',
  ...
  // ===== 6. Multi-Channel Customer Support =====
  {
    ...
    diagramImage: '/automations/customer-support.webp',
  ...
  // ===== 7. E-Commerce Order & Inventory =====
  {
    ...
    diagramImage: '/automations/ecommerce-sync.webp',
  ...
  // ===== 8. Brand Sentiment & Social Listening =====
  {
    ...
    diagramImage: '/automations/sentiment-analysis.webp',
