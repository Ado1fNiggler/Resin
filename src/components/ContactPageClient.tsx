        ...
        <div className={styles.container}>
          <div className={styles.workshopGrid}>
            ...
            <motion.div className={styles.workshopText} {...reveal(0.1)}>
              ...
              <p>
                Πάνω από την πόρτα η χειρόγραφη πινακίδα γράφει ακόμα
                «Επιπλοποιείον <em>το ρετσίνι</em>» — αναλλοίωτη από τη δεκαετία
                του &apos;50, όταν ο πρώτος μάστορας της γειτονιάς έδωσε στο
                εργαστήρι αυτό το όνομα. Το κρατήσαμε ως έχει.
              </p>
              <p>
